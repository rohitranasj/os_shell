...
#include <time.h>
#include <fcntl.h>
#define BUFSIZE /BUFS 1000
#define INPBUF /INB 100
#define ARGMAX ARGM 10
#define GREEN /G "\x1b[92m"
#define BLUE  /B "\x1b[94m"
#define DEF  /D "\x1B[0m"
#define CYAN  /C "\x1b[96m"
...
int filepid,fd[2];
char cwd[BUFS];
char* argval[ARGM]; // our local argc, argv
